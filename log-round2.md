...
The last bit of functionality to add is the ability to edit recipes. Added an edit box, which could be toggled to appear and disappear the same as the Add box, though a little more complex as the edit box belongs to App but is triggered further down the hierachy. Starting to wonder if it needs to do that, though - why not have it live under the ingredients list that triggers it?

**Thoughts:** I'm just happy with how fast and painless this has been. I hope that wasn't too soon.

One thing that's starting to bug me is how much data flow is going back and forth. I should make a diagram, I'm starting to lose track.
